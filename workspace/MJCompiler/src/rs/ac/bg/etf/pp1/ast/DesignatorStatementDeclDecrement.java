...
public class DesignatorStatementDeclDecrement extends DesignatorStatementDecl {

    private DesignatorDecl DesignatorDecl;

    public DesignatorStatementDeclDecrement (DesignatorDecl DesignatorDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementDeclDecrement(\n");
