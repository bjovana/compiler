...
public class DesignatorStatementDeclIncrement extends DesignatorStatementDecl {

    private DesignatorDecl DesignatorDecl;

    public DesignatorStatementDeclIncrement (DesignatorDecl DesignatorDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementDeclIncrement(\n");
