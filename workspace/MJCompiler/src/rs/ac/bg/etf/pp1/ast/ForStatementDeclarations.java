...
public class ForStatementDeclarations extends ForStatementDecl {

    private StatementDeclList StatementDeclList;

    public ForStatementDeclarations (StatementDeclList StatementDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ForStatementDeclarations(\n");
