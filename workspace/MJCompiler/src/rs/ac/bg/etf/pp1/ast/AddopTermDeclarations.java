...
public class AddopTermDeclarations extends AddopTermDeclList {

    private AddopTermDeclList AddopTermDeclList;
    private AddopDecl AddopDecl;
    private TermDecl TermDecl;

    public AddopTermDeclarations (AddopTermDeclList AddopTermDeclList, AddopDecl AddopDecl, TermDecl TermDecl) {
        this.AddopTermDeclList=AddopTermDeclList;
        if(AddopTermDeclList!=null) AddopTermDeclList.setParent(this);
        this.AddopDecl=AddopDecl;
        if(AddopDecl!=null) AddopDecl.setParent(this);
    ...
    public AddopDecl getAddopDecl() {
        return AddopDecl;
    }

    public void setAddopDecl(AddopDecl AddopDecl) {
        this.AddopDecl=AddopDecl;
    }
    ...
    public void childrenAccept(Visitor visitor) {
        ...
        if(AddopDecl!=null) AddopDecl.accept(visitor);
    ...
    public void traverseTopDown(Visitor visitor) {
        ...
        if(AddopDecl!=null) AddopDecl.traverseTopDown(visitor);
    ...
    public void traverseBottomUp(Visitor visitor) {
        ...
        if(AddopDecl!=null) AddopDecl.traverseBottomUp(visitor);
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AddopTermDeclarations(\n");
        ...
        if(AddopDecl!=null)
            buffer.append(AddopDecl.toString("  "+tab));
        else
            buffer.append(tab+"  null");
        buffer.append("\n");
