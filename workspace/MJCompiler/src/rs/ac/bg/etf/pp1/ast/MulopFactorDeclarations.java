...
public class MulopFactorDeclarations extends MulopFactorDeclList {

    private MulopFactorDeclList MulopFactorDeclList;
    private MulopDecl MulopDecl;
    private FactorDecl FactorDecl;

    public MulopFactorDeclarations (MulopFactorDeclList MulopFactorDeclList, MulopDecl MulopDecl, FactorDecl FactorDecl) {
        this.MulopFactorDeclList=MulopFactorDeclList;
        if(MulopFactorDeclList!=null) MulopFactorDeclList.setParent(this);
        this.MulopDecl=MulopDecl;
        if(MulopDecl!=null) MulopDecl.setParent(this);
    ...
    public MulopDecl getMulopDecl() {
        return MulopDecl;
    }

    public void setMulopDecl(MulopDecl MulopDecl) {
        this.MulopDecl=MulopDecl;
    }
    ...
    public void childrenAccept(Visitor visitor) {
        ...
        if(MulopDecl!=null) MulopDecl.accept(visitor);
    ...
    public void traverseTopDown(Visitor visitor) {
        ...
        if(MulopDecl!=null) MulopDecl.traverseTopDown(visitor);
    ...
    public void traverseBottomUp(Visitor visitor) {
        ...
        if(MulopDecl!=null) MulopDecl.traverseBottomUp(visitor);
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MulopFactorDeclarations(\n");
        ...
        if(MulopDecl!=null)
            buffer.append(MulopDecl.toString("  "+tab));
        else
            buffer.append(tab+"  null");
        buffer.append("\n");
