...
public class CondStatementDeclaration extends CondStatementDecl {

    private StatementDecl StatementDecl;

    public CondStatementDeclaration (StatementDecl StatementDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CondStatementDeclaration(\n");
