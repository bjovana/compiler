...
public class ForStatementDeclaration extends ForStatementDecl {

    private StatementDecl StatementDecl;

    public ForStatementDeclaration (StatementDecl StatementDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ForStatementDeclaration(\n");
