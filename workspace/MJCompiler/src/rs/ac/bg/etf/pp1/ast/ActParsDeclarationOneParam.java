...
public class ActParsDeclarationOneParam extends ActParsDecl {

    private ExprDecl ExprDecl;

    public ActParsDeclarationOneParam (ExprDecl ExprDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ActParsDeclarationOneParam(\n");
