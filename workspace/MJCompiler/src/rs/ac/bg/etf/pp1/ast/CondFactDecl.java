...
public class CondFactDecl implements SyntaxNode {
    ...
    private CondFactOptArgDecl CondFactOptArgDecl;

    public CondFactDecl (ExprOptSignDecl ExprOptSignDecl, TermDecl TermDecl, AddopTermDeclList AddopTermDeclList, CondFactOptArgDecl CondFactOptArgDecl) {
        ...
        this.CondFactOptArgDecl=CondFactOptArgDecl;
        if(CondFactOptArgDecl!=null) CondFactOptArgDecl.setParent(this);
    }
    ...
    public CondFactOptArgDecl getCondFactOptArgDecl() {
        return CondFactOptArgDecl;
    }

    public void setCondFactOptArgDecl(CondFactOptArgDecl CondFactOptArgDecl) {
        this.CondFactOptArgDecl=CondFactOptArgDecl;
    }
    ...
    public void childrenAccept(Visitor visitor) {
        ...
        if(CondFactOptArgDecl!=null) CondFactOptArgDecl.accept(visitor);
    }
    ...
    public void traverseTopDown(Visitor visitor) {
        ...
        if(CondFactOptArgDecl!=null) CondFactOptArgDecl.traverseTopDown(visitor);
    }
    ...
    public void traverseBottomUp(Visitor visitor) {
        ...
        if(CondFactOptArgDecl!=null) CondFactOptArgDecl.traverseBottomUp(visitor);
        accept(visitor);
    }
    ...
    public String toString(String tab) {
        ...
        if(CondFactOptArgDecl!=null)
            buffer.append(CondFactOptArgDecl.toString("  "+tab));
        else
            buffer.append(tab+"  null");
        buffer.append("\n");
