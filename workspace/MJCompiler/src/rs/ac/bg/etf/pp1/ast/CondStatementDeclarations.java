...
public class CondStatementDeclarations extends CondStatementDecl {

    private StatementDeclList StatementDeclList;

    public CondStatementDeclarations (StatementDeclList StatementDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CondStatementDeclarations(\n");
