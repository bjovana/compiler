...
public class StatementDeclDesignator extends StatementDecl {

    private DesignatorStatementDecl DesignatorStatementDecl;

    public StatementDeclDesignator (DesignatorStatementDecl DesignatorStatementDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StatementDeclDesignator(\n");
