...
public class CondFactOptArgDeclaration extends CondFactOptArgDecl {

    private RelopDecl RelopDecl;
    private ExprOptSignDecl ExprOptSignDecl;
    private TermDecl TermDecl;
    private AddopTermDeclList AddopTermDeclList;

    public CondFactOptArgDeclaration (RelopDecl RelopDecl, ExprOptSignDecl ExprOptSignDecl, TermDecl TermDecl, AddopTermDeclList AddopTermDeclList) {
        this.RelopDecl=RelopDecl;
        if(RelopDecl!=null) RelopDecl.setParent(this);
    ...
    public RelopDecl getRelopDecl() {
        return RelopDecl;
    }

    public void setRelopDecl(RelopDecl RelopDecl) {
        this.RelopDecl=RelopDecl;
    }
    ...
    public void childrenAccept(Visitor visitor) {
        if(RelopDecl!=null) RelopDecl.accept(visitor);
    ...
    public void traverseTopDown(Visitor visitor) {
        accept(visitor);
        if(RelopDecl!=null) RelopDecl.traverseTopDown(visitor);
    ...
    public void traverseBottomUp(Visitor visitor) {
        if(RelopDecl!=null) RelopDecl.traverseBottomUp(visitor);
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CondFactOptArgDeclaration(\n");

        if(RelopDecl!=null)
            buffer.append(RelopDecl.toString("  "+tab));
        else
