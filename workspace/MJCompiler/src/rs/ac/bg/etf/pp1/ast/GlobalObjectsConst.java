...
public class GlobalObjectsConst extends GlobalObjectDeclList {

    private GlobalObjectDeclList GlobalObjectDeclList;
    private ConstDecl ConstDecl;

    public GlobalObjectsConst (GlobalObjectDeclList GlobalObjectDeclList, ConstDecl ConstDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("GlobalObjectsConst(\n");
