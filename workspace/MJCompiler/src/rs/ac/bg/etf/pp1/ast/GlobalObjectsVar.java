...
public class GlobalObjectsVar extends GlobalObjectDeclList {

    private GlobalObjectDeclList GlobalObjectDeclList;
    private VarDecl VarDecl;

    public GlobalObjectsVar (GlobalObjectDeclList GlobalObjectDeclList, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("GlobalObjectsVar(\n");
