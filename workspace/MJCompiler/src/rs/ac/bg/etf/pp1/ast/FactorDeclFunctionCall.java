...
public class FactorDeclFunctionCall extends FactorDecl {

    private DesignatorDecl DesignatorDecl;
    private ActParsDeclList ActParsDeclList;

    public FactorDeclFunctionCall (DesignatorDecl DesignatorDecl, ActParsDeclList ActParsDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorDeclFunctionCall(\n");
